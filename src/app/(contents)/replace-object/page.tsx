...
const Page = () => {
    ...
    const date = new Date()
    const defaultName = `Replace object - ${date.getDate()}.${date.getMonth()}.${date.getFullYear()}`
    ...
    return (
        <div className='w-full max-w-[1000px]'>
            <form action="" method='POST' onSubmit={handleSubmit}>
                ...
                <div className="form-row mt-3 flex gap-3">
                    <div className="flex-1">
                        <label className='block text-lg font-semibold' htmlFor="replace_from">Replace from <span className="required">*</span></label>
                        <input className='input' type="text" name="replace_from" id="replace_from" required />
                    </div>
                    <div className="flex-1">
                        <label className='block text-lg font-semibold' htmlFor="replace_to">Replace to <span className="required">*</span></label>
                        <input className='input' type="text" name="replace_to" id="replace_to" required />
                    </div>
                </div>
